            ...
            {!finished && stimuli_num >= 0 &&
                <div class="container-col screen-center black-background">
                    <div class="item-col container-row screen-center">
                        <img class="item-row" src={`/static/images/grouping/group_${stimuli_num + classify * max_stimuli_num}/1.jpg`} alt="no image" />

                        <img class="item-row" src={`/static/images/grouping/group_${stimuli_num + classify * max_stimuli_num}/2.jpg`} alt="no image" />
                    </div>
                </div>
            }
